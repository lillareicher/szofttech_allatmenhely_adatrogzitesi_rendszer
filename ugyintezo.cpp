...
void Ugyintezo::addSetaltatasIdopont()
{
    ...
    cout << "Melyik allatnak szeretne idopontot feltolteni setaltatasra?: " << endl;
    cin >> nev;
    if(Allatok::allatVan(nev) == true){
        cout << "Irja be a datumot szokozokkel elvalasztva: ";
        ...
        cout << "Nincs ilyen allat a menhelyen." << endl;
    }
}
...
void Ugyintezo::addOnkentesIdopont()
{
    ...
    int ev, honap, nap, ora;
    cout << "Milyen tevekenysegre szeretne onkentes segitseget kerni? Szokoz eseten (_) alulvonast hasznaljon. " << endl;
    cin >> nev;
    cout << "Irja be a datumot szokozokkel elvalasztva: ";
    cin >> ev >> honap >> nap >> ora;
    if(Idopontok::validDatum(ev, honap, nap, ora))
    {
        ...
        outputFile.close();
        cout << "Sikeres onkentestevekenyseg hozzaadas. " << endl;
    }
    else{
        cout << "Nem megfelelo a datum." << endl;
    }
